...
export function SalesCard() {
	return (
		<div className='shadow-lg rounded-2xl w-36 p-4 bg-white bg-gray-800'>
			<div className='flex items-center'>
				...
				<p className='text-md text-gray-50 ml-2'>Sales</p>
			</div>
			<div className='flex flex-col justify-start'>
				<p className=' text-4xl text-left text-white font-bold my-4'>36K</p>
