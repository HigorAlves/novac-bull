...
import animationData from 'src/assets/lottie/bull-logo.json'

import { FinanceCard, SalesCard } from '~/components'
...
export default function Home(): JSX.Element {
	return (
		<main>
			<section className='flex items-center text-gray-400 bg-gray-900 body-font h-screen'>
				<div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
					<div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center'>
						<h1 className='title-font sm:text-4xl text-3xl mb-4 font-medium text-white'>
							Gerencie sua vida financeira e seus investimentos em um so lugar!
						</h1>
						<p className='mb-8 leading-relaxed'>
							Uma plataforma completa para você acompanhar os seus investimentos
							com segurança.
						</p>
