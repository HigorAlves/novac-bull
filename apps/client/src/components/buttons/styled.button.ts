...
export const BaseComponent = styled.button(
	({ primary, secondary }: IBaseComponent) => [
		tw`sm:ml-8 ml-0 whitespace-nowrap inline-flex items-center justify-center px-4 py-3 border border-transparent rounded-md shadow-sm text-base font-medium`,
